...
function setup() {
	...
	catcher1 = Bodies.rectangle(400,660,200,10);
	World.add(world,catcher1)
	
	catcher2 = Bodies.rectangle(300,610,10,100)
	World.add(world,catcher2)

	catcher = Bodies.rectangle(500,610,10,100)
	World.add(world,catcher3)
}
